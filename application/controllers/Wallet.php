...
class Wallet extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('wallet-page', $data);
    }
    ...
    public function create() {
        ...
        if ($this->input->post('particulars') != "") {
            ...
            $files = array('id' => $no, 'user' => $this->session->userdata('username'), 'date' => date('Y-m-d H:i:s'), 'orgID' => $this->session->userdata('orgID'), 'particulars' => $this->input->post('particulars'), 'amount' => $this->input->post('amount'), 'reference' => $this->input->post('reference'), 'method' => $this->input->post('method'), 'sync' =>  date('Y-m-d H:i:s'));
