...
<div class="page-content">
    <div class="row">
        <div class="col-md-12">          
            ...
            <h3 class="content-header"><font class="blue">Payments report</font></h3>
    ...
    $(document).ready(function ()
    {
        ...
        $("#generate").on("click", function (e) {
            ...
            if (from.length > 0) {
                ...
                $.post("<?php echo base_url() ?>index.php/payment/report", {from: from, to: to, storeID: storeID, type: type}
                , function (response) {
