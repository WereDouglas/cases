                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu toggled ">
                            <div class="menu_section infobox-container">
                                <h3>Home</h3>
                                <ul class="nav side-menu">
                                    
                                        <li><a href="<?php echo base_url() . "index.php/time/calendar"; ?>" target="frame"><i class="fa fa-calendar" style="color:#60ace0"></i> Calendar </a> </li>
                                    
                                    <?php if (strpos($this->session->userdata('views'), 'time') == true || strpos($this->session->userdata('views'), 'sheets') == true) { ?>
                                        <li><a href="<?php echo base_url() . "index.php/time/"; ?>" target="frame"><i class="fa fa-balance-scale" style="color:#60ace0"></i>Time sheet</a>
                                        </li>
                                    <?php } ?>
                                    <?php if (strpos($this->session->userdata('views'), 'clients') == true) { ?>
                                        <li><a href="<?php echo base_url() . "index.php/client"; ?>" target="frame"><i class="fa fa-user " style="color:#ac8f74"></i>Clients</a>

                                        </li>
                                    <?php } ?>

                                    <li><a href="<?php echo base_url() . "index.php/file/"; ?>" target="frame"><i class="fa fa-folder" style="color:#fe4500"></i>Files/Cases</a>

                                    </li>

                                    <li><a href="<?php echo base_url() . "index.php/document"; ?>" target="frame"><i class="fa fa-clone" style="color:#364a5e"></i>Documents<span class="label label-danger pull-right">
                                                <?php
                                    ...
                                    <li><a><i class="fa fa-briefcase" style="color:#5fba7c"></i>Accounts & Finance<span class="fa fa-chevron-down"></span></a>
                                    ...
                                    <li><a><i class="fa fa-cogs" style="color:#fde377"></i>Setup<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo base_url() . "index.php/library"; ?>" target="frame"><i class="fa fa-file" style="color:#eeeef2"></i>Library<span class="label label-danger pull-right">
                                            </span></a>
...
<!--                                    <li><a href="<?php echo base_url() . "index.php/message/"; ?>" target="frame"><i class="fa fa-envelope-o"></i> Messages </a></li>                                  -->
                                    ...
                                    <li><a href="<?php echo base_url() . "files/Cp.msi"; ?>"><i class="fa fa-laptop" style="color:#60ace0"></i> Desktop application<span class="label label-success pull-right">Coming Soon</span></a></li>
                ...
                <div class="right_col" role="main">                    <!-- top tiles -->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <iframe id="frame" name="frame" frameborder="no" border="0" onload="resizeIframe(this)" scrolling="no"  style="padding: 10px; min-height:600px;" width="100%" class="span12" src="<?php echo base_url() . "index.php/time/calendar"; ?>"> </iframe>         
