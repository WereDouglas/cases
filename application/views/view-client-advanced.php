                ...
                if (is_array($users) && count($users)) {
                    foreach ($users as $loop) {
                        ...
                        <tr class="odd">
                            ...
                            <td id="status:<?php echo $loop->clientID; ?>" contenteditable="true"><span class="red"><?php echo $loop->status; ?></span></td>

                            <td id="contact:<?php echo $loop->clientID; ?>" contenteditable="true"><?php echo $loop->contact; ?></td>
                              <td class="edit_td">
                                <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/client/profile/" . $loop->name; ?>"><li class="fa fa-folder">View</li></a>
