...
?>
            ...
            freebusys: [
            {'start': new Date(year, month, day), 'end': new Date(year, month, day + 3), 'free': false, userId: [0, 1, 2, 3,4,5,]},
    ...
    timeslotsPerHour: 4,
            ...
            users: [<?php foreach ($users as $loop) { ?> '<?php echo $loop->surname; ?>',   <?php } ?>, 'user 1', 'user 2', 'user 4'],
